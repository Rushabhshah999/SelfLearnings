...
public class PersonEndpoint implements MarshallingPersonService {
    ...
    public PersonResponse getPersons(GetPersonsRequest request) 
    {
    			...
    			personResponse.getPerson().addAll(persons);
    ...
    @PayloadRoot(localPart=SAVE_PERSONS_REQUEST, namespace=NAMESPACE)
    public PersonResponse savePerson(PersonResponse request) 
    {
    			return request;
